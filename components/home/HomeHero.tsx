...
export function HomeHero({
  ...
  return (
    <section className="home-hero relative isolate z-20 w-full">
      <div className="home-hero-photo relative min-h-[268px] w-full sm:min-h-0 sm:h-[308px] md:h-[328px] lg:h-[348px]">
        <div className="home-hero-photo-fade pointer-events-none absolute inset-0">
          <Image
            alt={hub.panoramaAlt}
          ...
          <div
            aria-hidden
            className="absolute inset-x-0 bottom-0 z-[2] h-16 sm:h-20 md:h-24"
            style={{
              background:
        ...
        <div className="relative z-[1] flex min-h-[268px] flex-col sm:absolute sm:inset-0 sm:min-h-0">
