...
export function liveProfessionalToBusinessPreview(
  ...
  return {
    ...
    googleMapsUrl: null,
    googleRating: professional.googleRating ?? null,
    googleReviewsCount: professional.googleReviewsCount ?? 0,
    facebookUrl: null,
    tiktokUrl: null,
    yelpUrl: null,
    yelpRating: professional.yelpRating ?? null,
    yelpReviewsCount: professional.yelpReviewsCount ?? 0,
    trustpilotUrl: null,
    trustpilotRating: professional.trustpilotRating ?? null,
    trustpilotReviewsCount: professional.trustpilotReviewsCount ?? 0,
    facebookRecommendPct: professional.facebookRecommendPct ?? null,
    facebookReviewsCount: professional.facebookReviewsCount ?? 0,
    bookingUrl: null,
    instagramUrl,
