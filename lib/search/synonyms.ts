...
const SYNONYM_GROUPS: readonly (readonly string[])[] = [
  ...
  // Subjects (tutor / courses) — keep in sync with subject-anchors.ts
  [
    "испанский",
    "испанского",
    "испанскому",
  ...
  ["английский", "английского", "английскому", "english"],
  ["французский", "французского", "french"],
  ["немецкий", "немецкого", "german"],
  ["китайский", "китайского", "chinese", "mandarin"],
  ["японский", "японского", "japanese"],
  ["корейский", "корейского", "korean"],
  ["итальянский", "итальянского", "italian"],
  ["математика", "математике", "математики", "math", "mathematics"],
  ["алгебра", "алгебре", "algebra"],
  ["геометрия", "геометрии", "geometry"],
  ["физика", "физике", "physics"],
  ["химия", "химии", "chemistry"],
  ["биология", "биологии", "biology"],
  ["информатика", "информатике", "programming", "coding"],
