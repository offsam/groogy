-- Expose community recommendation counters on the anti-scrape public catalog view
-- so listing / search mini-cards can show «чужие ×N» when present.
...
comment on view public.businesses_public is
  'Approved businesses without phone/email/URLs — safe for anon catalog. Includes city/ZIP and community recommendation count for listing cards.';
