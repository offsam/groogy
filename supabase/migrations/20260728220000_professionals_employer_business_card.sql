-- Employer company card: location + Google rating from linked businesses.
...
comment on view public.professionals_public is
  'Approved public professionals. Employer join includes city/ZIP and Google rating for workplace card.';
