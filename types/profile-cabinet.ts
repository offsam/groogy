...
export const CABINET_NAV_ITEMS = [
  ...
  { key: "businesses", label: "Мои бизнесы", href: "/me/businesses" },
  { key: "listings", label: "Мои объявления", href: "/me/listings" },
  { key: "services", label: "Мои услуги", href: "/me/services" },
  { key: "marketplace", label: "Купи-продай", href: "/marketplace" },
  { key: "surroundings", label: "Моё окружение", href: "/me/surroundings" },
